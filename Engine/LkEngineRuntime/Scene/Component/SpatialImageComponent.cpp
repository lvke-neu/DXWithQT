...
namespace LkEngine
{
	...
	void SpatialImageComponent::bindPipeState()
	{
		...
		m_pd3dImmediateContext->GSSetConstantBuffers(3, 1, m_pWorldMatrixCB.GetAddressOf());
		...
		m_pd3dImmediateContext->GSSetConstantBuffers(4, 1, m_pMaterialCB.GetAddressOf());
