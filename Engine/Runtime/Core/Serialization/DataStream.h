...
namespace Twinkle
{
    ...
    public:
        ...
        void write(const SerializationObject& value);
        ...
        bool read(SerializationObject& value);
    ...
    public:
        ...
        DataStream & operator << (const SerializationObject& value);
        ...
        DataStream & operator >> (SerializationObject& value);
