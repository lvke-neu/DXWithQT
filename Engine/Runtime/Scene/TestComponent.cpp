...
namespace Twinkle
{
	TestComponent::TestComponent()
	{
		...
		//vertexshader
		vertexShader = Singleton<RenderSystem>::GetInstance().CreateVertexShader("\\builtin\\BinShader\\BasicVertexShader.cso");
		
		//inputlayout
		inputLayout = Singleton<RenderSystem>::GetInstance().CreateInputLayout("\\builtin\\BinShader\\BasicVertexShader.cso", VertexPosNormalTex::ied);

		//pixelshader
		pixelShader = Singleton<RenderSystem>::GetInstance().CreatePixelShader("\\builtin\\BinShader\\BasicPixelShader.cso");
